...
Numerical values represent the number of seconds elapsed during 100.000 iterations of the respective code example, in other words, smaller numbers indicated better performance.
